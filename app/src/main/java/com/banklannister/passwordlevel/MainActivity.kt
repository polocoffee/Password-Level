package com.banklannister.passwordlevel
...
import com.banklannister.passwordlevel.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val drawableSuccess = ContextCompat.getDrawable(this, R.drawable.ic_pass)
        val drawableError = ContextCompat.getDrawable(this, R.drawable.ic_failed)
    ...
    private fun checkPasswordStrength(
        ...
        for (char in password) {
            ...
            if (Character.isLowerCase(char)) {
                hasLowerCase = true
                binding.hasLowerCase.setCompoundDrawablesWithIntrinsicBounds(
                    drawableSuccess,
                    null,
                    null,
                    null
            ...
            if (Character.isUpperCase(char)) {
                hasUpperCase = true
                binding.hasUpperCase.setCompoundDrawablesWithIntrinsicBounds(
                    drawableSuccess,
                    null,
                    null,
                    null
            ...
            if (!char.isLetterOrDigit()) {
                hasSymbol = true
                binding.hasSymbol.setCompoundDrawablesWithIntrinsicBounds(
                    drawableSuccess,
                    null,
                    null,
                    null
